...
class SquadPlayer:
    ...
    @int_property_decorator
    def penalty_kicks(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kick_attempts(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def corners_in(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def corners_out(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def corners_straight(self) -> Optional[int]:
        """
    ...
    def goals_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def assists_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_and_assists_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_non_penalty_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_and_assists_non_penalty_per_90(self) -> Optional[float]:
        """
        Returns a ``float`` of the number of non-penalty goals the player has
    ...
    @float_property_decorator
    def expected_goals_non_penalty(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_assists(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_assists_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_and_assists_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_non_penalty_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_and_assists_non_penalty_per_90(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def own_goals(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def own_goals_against(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def goals_against_per_90(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def shots_on_target_against(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def clean_sheets(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def clean_sheet_percentage(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_attempted(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_allowed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_saved(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_missed(self) -> Optional[int]:
        """
        Returns an ``int`` of the number of penalty kicks a keeper has faced
    ...
    @int_property_decorator
    def free_kick_goals_against(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def corner_kick_goals_against(self) -> Optional[int]:
        """
        Returns an ``int`` of the number of goals a keeper conceded as a result
    ...
    @float_property_decorator
    def post_shot_expected_goals(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def post_shot_expected_goals_per_shot(self) -> Optional[float]:
        """
        Returns a ``float`` of the number of goals a keeper was expected to
    ...
    @float_property_decorator
    def post_shot_expected_goals_minus_allowed(self) -> Optional[float]:
        """
        Returns a ``float`` of the number of goals a keeper was expected to
    ...
    @float_property_decorator
    def post_shot_expected_goals_minus_allowed_per_90(self) -> Optional[float]:
        """
        Returns a ``float`` of the number of goals a keeper was expected to
    ...
    @int_property_decorator
    def launches_completed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def launches_attempted(self) -> Optional[int]:
        """
        Returns an ``int`` of the number of passes longer than 40 yards a
        keeper attempted.
        """
    ...
    @float_property_decorator
    def launch_completion_percentage(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def keeper_passes_attempted(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def throws_attempted(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def launch_percentage(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def average_keeper_pass_length(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def goal_kicks_attempted(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def goal_kick_launch_percentage(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def average_goal_kick_length(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def opponent_cross_attempts(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def opponent_cross_stops(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def opponent_cross_stop_percentage(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def keeper_actions_outside_penalty_area(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def keeper_actions_outside_penalty_area_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def average_keeper_action_outside_penalty_distance(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def shots_on_target(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def free_kick_shots(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def shots_on_target_percentage(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def shots_on_target_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_per_shot(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_per_shot_on_target(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_non_penalty_per_shot(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def goals_minus_expected(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def non_penalty_minus_expected_non_penalty(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def assists_minus_expected(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def key_passes(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def passes_completed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def passes_attempted(self) -> Optional[int]:
        """
        Returns an ``int`` of the total number of passes the player has
        attempted.
        """
    ...
    @int_property_decorator
    def short_passes_completed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def short_passes_attempted(self) -> Optional[int]:
        """
        Returns an ``int`` of the total number of passes under 5 yards the
    ...
    @float_property_decorator
    def short_pass_completion(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def medium_passes_completed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def medium_passes_attempted(self) -> Optional[int]:
        """
        Returns an ``int`` of the total number of passes between 5 and 25 yards
    ...
    @float_property_decorator
    def medium_pass_completion(self) -> Optional[float]:
        """
        Returns a ``float`` of the player's overall pass completion rating for
    ...
    @int_property_decorator
    def long_passes_completed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def long_passes_attempted(self) -> Optional[int]:
        """
        Returns an ``int`` of the total number of passes greater than 25 yards
        the player has attempted.
        """
    ...
    @float_property_decorator
    def long_pass_completion(self) -> Optional[float]:
        """
        Returns a ``float`` of the player's overall pass completion rating for
    ...
    @int_property_decorator
    def free_kick_passes(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def through_balls(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def corner_kicks(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def throw_ins(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def final_third_passes(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_area_passes(self) -> Optional[int]:
        """
        Returns an ``int`` of the number of passes the player made into the
    ...
    @int_property_decorator
    def penalty_area_crosses(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def minutes_per_match(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def minutes_played_percentage(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def nineties_played(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def minutes_per_start(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def minutes_per_sub(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def unused_sub(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def goals_scored_on_pitch(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def goals_against_on_pitch(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def goal_difference_on_pitch(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def goal_difference_on_pitch_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def net_difference_on_pitch_per_90(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_on_pitch(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goals_against_on_pitch(self) -> Optional[float]:
        """
        Returns a ``float`` of the number of goals the team was expected to
    ...
    @float_property_decorator
    def expected_goal_difference(self) -> Optional[float]:
        """
    ...
    @float_property_decorator
    def expected_goal_difference_per_90(self) -> Optional[float]:
        """
        Returns a ``float`` of the difference between expected team goals
    ...
    @float_property_decorator
    def net_expected_goal_difference_per_90(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def soft_reds(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def fouls_committed(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def fouls_drawn(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def tackles_won(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_won(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def penalty_kicks_conceded(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def successful_dribbles(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def attempted_dribbles(self) -> Optional[int]:
        """
    ...
    @float_property_decorator
    def dribble_success_rate(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def dribblers_tackled(self) -> Optional[int]:
        """
    ...
    @int_property_decorator
    def dribblers_contested(self) -> Optional[int]:
        """
        Returns an ``int`` of the number of opponents who were attempting a
    ...
    @float_property_decorator
    def tackle_percentage(self) -> Optional[float]:
        """
    ...
    @int_property_decorator
    def times_dribbled_past(self) -> Optional[int]:
        """
...
class Roster:
    ...
    """
    def __init__(self, squad_id: str, doc=None):
        self._players: list[SquadPlayer] = []
